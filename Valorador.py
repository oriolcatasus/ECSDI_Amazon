...
def recomendaciones(req, content):
    ...
    for x3 in result3:
        ...
        result_message.add((x3.producto, agn.nombre, Literal(str(x3.nombre))))
        result_message.add((x3.producto, agn.peso, Literal(str(x3.peso))))
        result_message.add((x3.producto, agn.precio, Literal(str(x3.precio))))
        result_message.add((x3.producto, agn.tieneMarca, Literal(str(x3.tieneMarca))))
